 ...
 */
typedef void *kmem_cache_isolate_func(struct kmem_cache *, void **, int);

/*
 * kmem_cache_migrate_func is called with no locks held and interrupts
 ...
 */
typedef void kmem_cache_migrate_func(struct kmem_cache *, void **,
